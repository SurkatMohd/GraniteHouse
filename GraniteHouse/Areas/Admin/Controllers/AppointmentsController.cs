...
namespace GraniteHouse.Areas.Admin.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchName=null, string searchEmail=null, string searchPhone=null, string searchDate=null)
        {
            ...
            if (searchPhone != null)
            {
                appointmentVM.Appointments = appointmentVM.Appointments.Where(a => a.CustomerPhoneNumbere.ToLower().Contains(searchPhone.ToLower())).ToList();
            }
            if (searchDate != null)
            {
                try
        ...
        public async Task<IActionResult> Edit(int id, AppointmentDetailsViewModel objAppointmentVM)
        {
            if (ModelState.IsValid)
            {
                ...
                appointmentFromDb.CustomerPhoneNumbere = objAppointmentVM.Appointment.CustomerPhoneNumbere;
